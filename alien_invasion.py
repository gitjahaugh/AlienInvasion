...
class AlienInvasion:
    ...
    def _check_bullet_alien_collisions(self):
        ...
        if not self.aliens:
            # Destory exisiting bullets and create new fleet.
            self.bullets.empty()
            self._create_fleet()
    ...
    def _create_fleet(self):
        ...
        # Spacin between each lien is equal to one alien width.
        alien = Alien(self)
    ...
    def _check_fleet_edges(self):
        """Respond appropriately if any aliens hve reached an edge."""
        for alien in self.aliens.sprites():
